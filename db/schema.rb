...
ActiveRecord::Schema.define(version: 20180821074537) do
  ...
  create_table "favourites", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    ...
    t.index ["micropost_id"], name: "index_favourites_on_micropost_id", using: :btree
  ...
  add_foreign_key "favourites", "microposts"
